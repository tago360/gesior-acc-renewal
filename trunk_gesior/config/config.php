...
//Renewal
$config['site']['avatar_size_kb'] = 512;
$config['site']['avatar_size']['max_width'] = '64';
$config['site']['avatar_size']['max_height'] = '64';
...
$config['site']['last_deaths_limit'] = 20; // max. number of death on last death page
